...
export const data = [
  {
    ...
    title: 'Deploy Next.js 14 project to your github.io page',
    content: <DeployNext14ProjectToGithubioPage />,
  },
  {
    id: 2,
    slug: 'add-prettier-to-nextjs-project',
    title: 'Add Prettier to Next.js project',
    content: <AddPrettierToNextjsProject />,
  },
];
